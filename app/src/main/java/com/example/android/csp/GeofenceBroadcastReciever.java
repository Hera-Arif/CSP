...
public class GeofenceBroadcastReciever extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        Log.d ("Never Ending Service", "Inside onRecieve");
        //Log.i("GeofenceBroadCastRcvr","Inside onRecieve");
       // Log.i(SensorRestarterBroadcastReceiver.class.getSimpleName(), "Service Stops! Oooooooooooooppppssssss!!!!");
        context.startService(new Intent(context, GeofenceIntentService.class));
    }
}
